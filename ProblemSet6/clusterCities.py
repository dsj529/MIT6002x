...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        closest = None
        for first in self.points:
            for second in other.points:
    ...
    def maxLinkageDist(self, other):
        ...
        for first in self.points:
            for second in other.points:
                dist = first.distance(second)
                if not farthest or dist > farthest:
                    farthest = dist
        return farthest
    ...
    def averageLinkageDist(self, other):
        ...
        for first in self.points:
            for second in other.points:
                tot += first.distance(second)
        return tot / (len(self.points) * len(other.points))
